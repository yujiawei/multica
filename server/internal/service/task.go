...
func NewTaskService(q *db.Queries, hub *realtime.Hub, bus *events.Bus, webhookSvc *WebhookService) *TaskService {
	return &TaskService{Queries: q, Hub: hub, Bus: bus, WebhookSvc: webhookSvc}
}
